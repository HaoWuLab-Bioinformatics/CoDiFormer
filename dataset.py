...
from torch_geometric.datasets import Amazon, Coauthor, HeterophilousGraphDataset, WikiCS, Planetoid
...
def load_planetoid_dataset(data_dir, name):
    ...
    torch_dataset = Planetoid(root=f'{data_dir}/Planetoid', name=pyg_name, split='public', transform=transform)
